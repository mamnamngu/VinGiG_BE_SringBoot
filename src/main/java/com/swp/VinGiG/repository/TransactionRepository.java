...
public interface TransactionRepository  extends JpaRepository<Transaction, Long>, JpaSpecificationExecutor<Transaction>{
	...
	public List<Transaction> findByWalletIDInterval(@Param("walletID") long walletID, @Param("dateMin") Date dateMin, @Param("dateMax") Date dateMax);
	...
	public List<Transaction> findByWalletIDTypeDepositInterval(@Param("walletID") long walletID, @Param("dateMin") Date dateMin, @Param("dateMax") Date dateMax);
	...
	public List<Transaction> findByWalletIDTypeBookingFeeInterval(@Param("walletID") long walletID, @Param("dateMin") Date dateMin, @Param("dateMax") Date dateMax);
	...
	public List<Transaction> findByWalletIDBySubscriptionFeeInterval(@Param("walletID") long walletID, @Param("dateMin") Date dateMin, @Param("dateMax") Date dateMax);
